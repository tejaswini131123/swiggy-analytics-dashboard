...
A dynamic and interactive analytics dashboard built to explore food delivery business performance using Swiggy-style sales data. The dashboard provides deep insights into sales trends, customer ratings, order behavior, food category performance, and regional analytics to support data-driven business decisions.
...
The goal is to transform raw food delivery data into actionable insights that improve operational efficiency, customer satisfaction, and sales performance.
...
Which food categories drive the highest sales?
Which cities contribute most to revenue?
How customer ratings impact business performance?
Which days or months generate peak orders?
What patterns exist in customer ordering behavior?

Without a centralized analytics solution, deriving meaningful insights becomes difficult and time-consuming.

🎯 **Goal of the Dashboard**

The dashboard aims to:

Provide a centralized view of food delivery performance.
Monitor KPIs like sales, ratings, and order trends.
...
![Swiggy Dashboard](https://raw.githubusercontent.com/tejaswini131123/swiggy-analytics-dashboard/main/2026-05-08.png)
...
Delivery time optimization metrics
Profitability analysis by category and region
